...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let dalleOriginal = ImageAsset(name: "DalleOriginal")
    ...
    internal static let imgPizza = ImageAsset(name: "img_pizza")
    internal static let imgSpaghetti = ImageAsset(name: "img_spaghetti")
    internal static let leftHeadBack = ImageAsset(name: "left_head_back")
    internal static let rightHeadBack = ImageAsset(name: "right_head_back")
    ...
    internal static let imgGeorgeW = ImageAsset(name: "img_george_w")
